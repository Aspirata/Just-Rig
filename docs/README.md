...
* Добавить язык
* Создать статичный сайт для более приятного процесса ознакомления и скачивания рига
...
Вы можете свободно использовать его в своих анимациях, а также модифицировать с указанием меня как автора рига:
* **Discord:** `aspirata`
